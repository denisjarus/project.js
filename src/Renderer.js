function Renderer(context) {
    ...
    var settings = {
            magFilter: Renderer.TEXTURE_FILTER_BILINEAR,
            minFilter: Renderer.TEXTURE_FILTER_BILINEAR,
            anisotropy: 1
        };
    ...
    Object.defineProperties(this, {
        ...
        magFilter: {
            get: function() {
                return settings.magFilter;
            },
            set: function(value) {
                if (settings.magFilter !== value) {
                    settings.magFilter = value;
                    updateSettings = true;
                }
            }
        },
        minFilter: {
            get: function() {
                return settings.minFilter;
            },
            set: function(value) {
                if (settings.minFilter !== value) {
                    settings.minFilter = value;
                    updateSettings = true
                }
            }
        },
        anisotropy: {
            ...
            set: function(value) {
                if (settings.anisotropy !== value) {
                    settings.anisotropy = value;
                    updateSettings = true;
                }
            }
        }
    ...
    function setTexture(target, texture) {
        ...
        if (cache.config) {
            ...
            gl.texParameteri(target, gl.TEXTURE_MAG_FILTER, settings.magFilter);
            gl.texParameteri(target, gl.TEXTURE_MIN_FILTER, settings.minFilter);

            if (glAnisotropicFilter) {
                gl.texParameteri(target, glAnisotropicFilter.TEXTURE_MAX_ANISOTROPY_EXT, settings.anisotropy);
            }
